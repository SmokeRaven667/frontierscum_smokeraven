 ...
 * @extends {ActorSheet}
 */
export class FSActorSheetCreature extends FSActorSheet {
  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["frontierscum", "sheet", "actor", "creature"],
      template: "systems/frontierscum/templates/actor/creature-sheet.html",
      width: 720,
      height: 680,
      tabs: [
        {
